var wt=Object.defineProperty;var De=e=>{throw TypeError(e)};var jt=(e,t,s)=>t in e?wt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var m=(e,t,s)=>jt(e,typeof t!="symbol"?t+"":t,s),Oe=(e,t,s)=>t.has(e)||De("Cannot "+s);var a=(e,t,s)=>(Oe(e,t,"read from private field"),s?s.call(e):t.get(e)),p=(e,t,s)=>t.has(e)?De("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),f=(e,t,s,r)=>(Oe(e,t,"write to private field"),r?r.call(e,s):t.set(e,s),s),x=(e,t,s)=>(Oe(e,t,"access private method"),s);var $e=(e,t,s,r)=>({set _(n){f(e,t,n,s)},get _(){return a(e,t,r)}});var ze=(e,t,s)=>(r,n)=>{let i=-1;return o(0);async function o(c){if(c<=i)throw new Error("next() called multiple times");i=c;let l,d=!1,u;if(e[c]?(u=e[c][0][0],r.req.routeIndex=c):u=c===e.length&&n||void 0,u)try{l=await u(r,()=>o(c+1))}catch(h){if(h instanceof Error&&t)r.error=h,l=await t(h,r),d=!0;else throw h}else r.finalized===!1&&s&&(l=await s(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},Et=Symbol(),At=async(e,t=Object.create(null))=>{const{all:s=!1,dot:r=!1}=t,i=(e instanceof nt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Pt(e,{all:s,dot:r}):{}};async function Pt(e,t){const s=await e.formData();return s?St(s,t):{}}function St(e,t){const s=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?Rt(s,n,r):s[n]=r}),t.dot&&Object.entries(s).forEach(([r,n])=>{r.includes(".")&&(Ct(s,r,n),delete s[r])}),s}var Rt=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Ct=(e,t,s)=>{let r=e;const n=t.split(".");n.forEach((i,o)=>{o===n.length-1?r[i]=s:((!r[i]||typeof r[i]!="object"||Array.isArray(r[i])||r[i]instanceof File)&&(r[i]=Object.create(null)),r=r[i])})},Qe=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Tt=e=>{const{groups:t,path:s}=Ot(e),r=Qe(s);return _t(r,t)},Ot=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,r)=>{const n=`@${r}`;return t.push([n,s]),n}),{groups:t,path:e}},_t=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[r]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[s][1]);break}}return e},je={},Mt=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const r=`${e}#${t}`;return je[r]||(s[2]?je[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:je[r]=[e,s[1],!0]),je[r]}return null},Ie=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},kt=e=>Ie(e,decodeURI),et=e=>{const t=e.url,s=t.indexOf("/",t.charCodeAt(9)===58?13:8);let r=s;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const i=t.indexOf("?",r),o=t.slice(s,i===-1?void 0:i);return kt(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return t.slice(s,r)},Ht=e=>{const t=et(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},se=(e,t,...s)=>(s.length&&(t=se(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),tt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&r===""?s.push("/"):s.push(r);const i=n.replace("?","");r+="/"+i,s.push(r)}else r+="/"+n}),s.filter((n,i,o)=>o.indexOf(n)===i)},_e=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ie(e,rt):e):e,st=(e,t,s)=>{let r;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf(`?${t}`,8);for(o===-1&&(o=e.indexOf(`&${t}`,8));o!==-1;){const c=e.charCodeAt(o+t.length+1);if(c===61){const l=o+t.length+2,d=e.indexOf("&",l);return _e(e.slice(l,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const o=e.indexOf("&",i+1);let c=e.indexOf("=",i);c>o&&o!==-1&&(c=-1);let l=e.slice(i+1,c===-1?o===-1?void 0:o:c);if(r&&(l=_e(l)),i=o,l==="")continue;let d;c===-1?d="":(d=e.slice(c+1,o===-1?void 0:o),r&&(d=_e(d))),s?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},It=st,Nt=(e,t)=>st(e,t,!0),rt=decodeURIComponent,Le=e=>Ie(e,rt),ie,C,z,it,at,ke,F,Ge,nt=(Ge=class{constructor(e,t="/",s=[[]]){p(this,z);m(this,"raw");p(this,ie);p(this,C);m(this,"routeIndex",0);m(this,"path");m(this,"bodyCache",{});p(this,F,e=>{const{bodyCache:t,raw:s}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,f(this,C,s),f(this,ie,{})}param(e){return e?x(this,z,it).call(this,e):x(this,z,at).call(this)}query(e){return It(this.url,e)}queries(e){return Nt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,r)=>{t[r]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await At(this,e))}json(){return a(this,F).call(this,"text").then(e=>JSON.parse(e))}text(){return a(this,F).call(this,"text")}arrayBuffer(){return a(this,F).call(this,"arrayBuffer")}blob(){return a(this,F).call(this,"blob")}formData(){return a(this,F).call(this,"formData")}addValidatedData(e,t){a(this,ie)[e]=t}valid(e){return a(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Et](){return a(this,C)}get matchedRoutes(){return a(this,C)[0].map(([[,e]])=>e)}get routePath(){return a(this,C)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,C=new WeakMap,z=new WeakSet,it=function(e){const t=a(this,C)[0][this.routeIndex][1][e],s=x(this,z,ke).call(this,t);return s?/\%/.test(s)?Le(s):s:void 0},at=function(){const e={},t=Object.keys(a(this,C)[0][this.routeIndex][1]);for(const s of t){const r=x(this,z,ke).call(this,a(this,C)[0][this.routeIndex][1][s]);r&&typeof r=="string"&&(e[s]=/\%/.test(r)?Le(r):r)}return e},ke=function(e){return a(this,C)[1]?a(this,C)[1][e]:e},F=new WeakMap,Ge),Dt={Stringify:1},ot=async(e,t,s,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(c=>c({phase:t,buffer:n,context:r}))).then(c=>Promise.all(c.filter(Boolean).map(l=>ot(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},$t="text/plain; charset=UTF-8",Me=(e,t)=>({"Content-Type":e,...t}),pe,xe,I,ae,N,S,be,oe,le,Y,ve,ye,q,re,Ke,zt=(Ke=class{constructor(e,t){p(this,q);p(this,pe);p(this,xe);m(this,"env",{});p(this,I);m(this,"finalized",!1);m(this,"error");p(this,ae);p(this,N);p(this,S);p(this,be);p(this,oe);p(this,le);p(this,Y);p(this,ve);p(this,ye);m(this,"render",(...e)=>(a(this,oe)??f(this,oe,t=>this.html(t)),a(this,oe).call(this,...e)));m(this,"setLayout",e=>f(this,be,e));m(this,"getLayout",()=>a(this,be));m(this,"setRenderer",e=>{f(this,oe,e)});m(this,"header",(e,t,s)=>{this.finalized&&f(this,S,new Response(a(this,S).body,a(this,S)));const r=a(this,S)?a(this,S).headers:a(this,Y)??f(this,Y,new Headers);t===void 0?r.delete(e):s!=null&&s.append?r.append(e,t):r.set(e,t)});m(this,"status",e=>{f(this,ae,e)});m(this,"set",(e,t)=>{a(this,I)??f(this,I,new Map),a(this,I).set(e,t)});m(this,"get",e=>a(this,I)?a(this,I).get(e):void 0);m(this,"newResponse",(...e)=>x(this,q,re).call(this,...e));m(this,"body",(e,t,s)=>x(this,q,re).call(this,e,t,s));m(this,"text",(e,t,s)=>!a(this,Y)&&!a(this,ae)&&!t&&!s&&!this.finalized?new Response(e):x(this,q,re).call(this,e,t,Me($t,s)));m(this,"json",(e,t,s)=>x(this,q,re).call(this,JSON.stringify(e),t,Me("application/json",s)));m(this,"html",(e,t,s)=>{const r=n=>x(this,q,re).call(this,n,t,Me("text/html; charset=UTF-8",s));return typeof e=="object"?ot(e,Dt.Stringify,!1,{}).then(r):r(e)});m(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});m(this,"notFound",()=>(a(this,le)??f(this,le,()=>new Response),a(this,le).call(this,this)));f(this,pe,e),t&&(f(this,N,t.executionCtx),this.env=t.env,f(this,le,t.notFoundHandler),f(this,ye,t.path),f(this,ve,t.matchResult))}get req(){return a(this,xe)??f(this,xe,new nt(a(this,pe),a(this,ye),a(this,ve))),a(this,xe)}get event(){if(a(this,N)&&"respondWith"in a(this,N))return a(this,N);throw Error("This context has no FetchEvent")}get executionCtx(){if(a(this,N))return a(this,N);throw Error("This context has no ExecutionContext")}get res(){return a(this,S)||f(this,S,new Response(null,{headers:a(this,Y)??f(this,Y,new Headers)}))}set res(e){if(a(this,S)&&e){e=new Response(e.body,e);for(const[t,s]of a(this,S).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=a(this,S).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}f(this,S,e),this.finalized=!0}get var(){return a(this,I)?Object.fromEntries(a(this,I)):{}}},pe=new WeakMap,xe=new WeakMap,I=new WeakMap,ae=new WeakMap,N=new WeakMap,S=new WeakMap,be=new WeakMap,oe=new WeakMap,le=new WeakMap,Y=new WeakMap,ve=new WeakMap,ye=new WeakMap,q=new WeakSet,re=function(e,t,s){const r=a(this,S)?new Headers(a(this,S).headers):a(this,Y)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,c]of i)o.toLowerCase()==="set-cookie"?r.append(o,c):r.set(o,c)}if(s)for(const[i,o]of Object.entries(s))if(typeof o=="string")r.set(i,o);else{r.delete(i);for(const c of o)r.append(i,c)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??a(this,ae);return new Response(e,{status:n,headers:r})},Ke),w="ALL",Lt="all",Ft=["get","post","put","delete","options","patch"],lt="Can not add a route since the matcher is already built.",ct=class extends Error{},qt="__COMPOSED_HANDLER",Ut=e=>e.text("404 Not Found",404),Fe=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},O,j,ut,_,V,Ee,Ae,Be,dt=(Be=class{constructor(t={}){p(this,j);m(this,"get");m(this,"post");m(this,"put");m(this,"delete");m(this,"options");m(this,"patch");m(this,"all");m(this,"on");m(this,"use");m(this,"router");m(this,"getPath");m(this,"_basePath","/");p(this,O,"/");m(this,"routes",[]);p(this,_,Ut);m(this,"errorHandler",Fe);m(this,"onError",t=>(this.errorHandler=t,this));m(this,"notFound",t=>(f(this,_,t),this));m(this,"fetch",(t,...s)=>x(this,j,Ae).call(this,t,s[1],s[0],t.method));m(this,"request",(t,s,r,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${se("/",t)}`,s),r,n)));m(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(x(this,j,Ae).call(this,t.request,t,void 0,t.request.method))})});[...Ft,Lt].forEach(i=>{this[i]=(o,...c)=>(typeof o=="string"?f(this,O,o):x(this,j,V).call(this,i,a(this,O),o),c.forEach(l=>{x(this,j,V).call(this,i,a(this,O),l)}),this)}),this.on=(i,o,...c)=>{for(const l of[o].flat()){f(this,O,l);for(const d of[i].flat())c.map(u=>{x(this,j,V).call(this,d.toUpperCase(),a(this,O),u)})}return this},this.use=(i,...o)=>(typeof i=="string"?f(this,O,i):(f(this,O,"*"),o.unshift(i)),o.forEach(c=>{x(this,j,V).call(this,w,a(this,O),c)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??et:Ht}route(t,s){const r=this.basePath(t);return s.routes.map(n=>{var o;let i;s.errorHandler===Fe?i=n.handler:(i=async(c,l)=>(await ze([],s.errorHandler)(c,()=>n.handler(c,l))).res,i[qt]=n.handler),x(o=r,j,V).call(o,n.method,n.path,i)}),this}basePath(t){const s=x(this,j,ut).call(this);return s._basePath=se(this._basePath,t),s}mount(t,s,r){let n,i;r&&(typeof r=="function"?i=r:(i=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=i?l=>{const d=i(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=se(this._basePath,t),d=l==="/"?0:l.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const c=async(l,d)=>{const u=await s(n(l.req.raw),...o(l));if(u)return u;await d()};return x(this,j,V).call(this,w,se(t,"*"),c),this}},O=new WeakMap,j=new WeakSet,ut=function(){const t=new dt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,_,a(this,_)),t.routes=this.routes,t},_=new WeakMap,V=function(t,s,r){t=t.toUpperCase(),s=se(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:r};this.router.add(t,s,[r,n]),this.routes.push(n)},Ee=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Ae=function(t,s,r,n){if(n==="HEAD")return(async()=>new Response(null,await x(this,j,Ae).call(this,t,s,r,"GET")))();const i=this.getPath(t,{env:r}),o=this.router.match(n,i),c=new zt(t,{path:i,matchResult:o,env:r,executionCtx:s,notFoundHandler:a(this,_)});if(o[0].length===1){let d;try{d=o[0][0][0][0](c,async()=>{c.res=await a(this,_).call(this,c)})}catch(u){return x(this,j,Ee).call(this,u,c)}return d instanceof Promise?d.then(u=>u||(c.finalized?c.res:a(this,_).call(this,c))).catch(u=>x(this,j,Ee).call(this,u,c)):d??a(this,_).call(this,c)}const l=ze(o[0],this.errorHandler,a(this,_));return(async()=>{try{const d=await l(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return x(this,j,Ee).call(this,d,c)}})()},Be),Se="[^/]+",me=".*",ge="(?:|/.*)",ne=Symbol(),Gt=new Set(".\\+*[^]$()");function Kt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===me||e===ge?1:t===me||t===ge?-1:e===Se?1:t===Se?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Z,J,M,Ve,He=(Ve=class{constructor(){p(this,Z);p(this,J);p(this,M,Object.create(null))}insert(t,s,r,n,i){if(t.length===0){if(a(this,Z)!==void 0)throw ne;if(i)return;f(this,Z,s);return}const[o,...c]=t,l=o==="*"?c.length===0?["","",me]:["","",Se]:o==="/*"?["","",ge]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let h=l[2]||Se;if(u&&l[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw ne;if(d=a(this,M)[h],!d){if(Object.keys(a(this,M)).some(g=>g!==me&&g!==ge))throw ne;if(i)return;d=a(this,M)[h]=new He,u!==""&&f(d,J,n.varIndex++)}!i&&u!==""&&r.push([u,a(d,J)])}else if(d=a(this,M)[o],!d){if(Object.keys(a(this,M)).some(u=>u.length>1&&u!==me&&u!==ge))throw ne;if(i)return;d=a(this,M)[o]=new He}d.insert(c,s,r,n,i)}buildRegExpStr(){const s=Object.keys(a(this,M)).sort(Kt).map(r=>{const n=a(this,M)[r];return(typeof a(n,J)=="number"?`(${r})@${a(n,J)}`:Gt.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof a(this,Z)=="number"&&s.unshift(`#${a(this,Z)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Z=new WeakMap,J=new WeakMap,M=new WeakMap,Ve),Re,we,We,Bt=(We=class{constructor(){p(this,Re,{varIndex:0});p(this,we,new He)}insert(e,t,s){const r=[],n=[];for(let o=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,c=!0,d}),!c)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[c]=n[o];for(let l=i.length-1;l>=0;l--)if(i[l].indexOf(c)!==-1){i[l]=i[l].replace(c,n[o][1]);break}}return a(this,we).insert(i,t,r,a(this,Re),s),r}buildRegExp(){let e=a(this,we).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,o)=>i!==void 0?(s[++t]=Number(i),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,r]}},Re=new WeakMap,we=new WeakMap,We),ht=[],Vt=[/^$/,[],Object.create(null)],Pe=Object.create(null);function ft(e){return Pe[e]??(Pe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Wt(){Pe=Object.create(null)}function Yt(e){var d;const t=new Bt,s=[];if(e.length===0)return Vt;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[g,y])=>u?1:g?-1:h.length-y.length),n=Object.create(null);for(let u=0,h=-1,g=r.length;u<g;u++){const[y,R,b]=r[u];y?n[R]=[b.map(([P])=>[P,Object.create(null)]),ht]:h++;let v;try{v=t.insert(R,h,y)}catch(P){throw P===ne?new ct(R):P}y||(s[h]=b.map(([P,ee])=>{const ue=Object.create(null);for(ee-=1;ee>=0;ee--){const[k,Ce]=v[ee];ue[k]=Ce}return[P,ue]}))}const[i,o,c]=t.buildRegExp();for(let u=0,h=s.length;u<h;u++)for(let g=0,y=s[u].length;g<y;g++){const R=(d=s[u][g])==null?void 0:d[1];if(!R)continue;const b=Object.keys(R);for(let v=0,P=b.length;v<P;v++)R[b[v]]=c[R[b[v]]]}const l=[];for(const u in o)l[u]=s[o[u]];return[i,l,n]}function te(e,t){if(e){for(const s of Object.keys(e).sort((r,n)=>n.length-r.length))if(ft(s).test(t))return[...e[s]]}}var U,G,de,mt,gt,Ye,Zt=(Ye=class{constructor(){p(this,de);m(this,"name","RegExpRouter");p(this,U);p(this,G);f(this,U,{[w]:Object.create(null)}),f(this,G,{[w]:Object.create(null)})}add(e,t,s){var c;const r=a(this,U),n=a(this,G);if(!r||!n)throw new Error(lt);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[w]).forEach(d=>{l[e][d]=[...l[w][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ft(t);e===w?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=te(r[d],t)||te(r[w],t)||[])}):(c=r[e])[t]||(c[t]=te(r[e],t)||te(r[w],t)||[]),Object.keys(r).forEach(d=>{(e===w||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([s,i])})}),Object.keys(n).forEach(d=>{(e===w||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([s,i]))});return}const o=tt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(h=>{var g;(e===w||e===h)&&((g=n[h])[u]||(g[u]=[...te(r[h],u)||te(r[w],u)||[]]),n[h][u].push([s,i-d+l+1]))})}}match(e,t){Wt();const s=x(this,de,mt).call(this);return this.match=(r,n)=>{const i=s[r]||s[w],o=i[2][n];if(o)return o;const c=n.match(i[0]);if(!c)return[[],ht];const l=c.indexOf("",1);return[i[1][l],c]},this.match(e,t)}},U=new WeakMap,G=new WeakMap,de=new WeakSet,mt=function(){const e=Object.create(null);return Object.keys(a(this,G)).concat(Object.keys(a(this,U))).forEach(t=>{e[t]||(e[t]=x(this,de,gt).call(this,t))}),f(this,U,f(this,G,void 0)),e},gt=function(e){const t=[];let s=e===w;return[a(this,U),a(this,G)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(i=>[i,r[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==w&&t.push(...Object.keys(r[w]).map(i=>[i,r[w][i]]))}),s?Yt(t):null},Ye),K,D,Ze,Jt=(Ze=class{constructor(e){m(this,"name","SmartRouter");p(this,K,[]);p(this,D,[]);f(this,K,e.routers)}add(e,t,s){if(!a(this,D))throw new Error(lt);a(this,D).push([e,t,s])}match(e,t){if(!a(this,D))throw new Error("Fatal error");const s=a(this,K),r=a(this,D),n=s.length;let i=0,o;for(;i<n;i++){const c=s[i];try{for(let l=0,d=r.length;l<d;l++)c.add(...r[l]);o=c.match(e,t)}catch(l){if(l instanceof ct)continue;throw l}this.match=c.match.bind(c),f(this,K,[c]),f(this,D,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(a(this,D)||a(this,K).length!==1)throw new Error("No active router has been determined yet.");return a(this,K)[0]}},K=new WeakMap,D=new WeakMap,Ze),fe=Object.create(null),B,A,X,ce,E,$,W,Je,pt=(Je=class{constructor(e,t,s){p(this,$);p(this,B);p(this,A);p(this,X);p(this,ce,0);p(this,E,fe);if(f(this,A,s||Object.create(null)),f(this,B,[]),e&&t){const r=Object.create(null);r[e]={handler:t,possibleKeys:[],score:0},f(this,B,[r])}f(this,X,[])}insert(e,t,s){f(this,ce,++$e(this,ce)._);let r=this;const n=Tt(t),i=[];for(let o=0,c=n.length;o<c;o++){const l=n[o],d=n[o+1],u=Mt(l,d),h=Array.isArray(u)?u[0]:l;if(h in a(r,A)){r=a(r,A)[h],u&&i.push(u[1]);continue}a(r,A)[h]=new pt,u&&(a(r,X).push(u),i.push(u[1])),r=a(r,A)[h]}return a(r,B).push({[e]:{handler:s,possibleKeys:i.filter((o,c,l)=>l.indexOf(o)===c),score:a(this,ce)}}),r}search(e,t){var c;const s=[];f(this,E,fe);let n=[this];const i=Qe(t),o=[];for(let l=0,d=i.length;l<d;l++){const u=i[l],h=l===d-1,g=[];for(let y=0,R=n.length;y<R;y++){const b=n[y],v=a(b,A)[u];v&&(f(v,E,a(b,E)),h?(a(v,A)["*"]&&s.push(...x(this,$,W).call(this,a(v,A)["*"],e,a(b,E))),s.push(...x(this,$,W).call(this,v,e,a(b,E)))):g.push(v));for(let P=0,ee=a(b,X).length;P<ee;P++){const ue=a(b,X)[P],k=a(b,E)===fe?{}:{...a(b,E)};if(ue==="*"){const L=a(b,A)["*"];L&&(s.push(...x(this,$,W).call(this,L,e,a(b,E))),f(L,E,k),g.push(L));continue}const[Ce,Ne,he]=ue;if(!u&&!(he instanceof RegExp))continue;const H=a(b,A)[Ce],yt=i.slice(l).join("/");if(he instanceof RegExp){const L=he.exec(yt);if(L){if(k[Ne]=L[0],s.push(...x(this,$,W).call(this,H,e,a(b,E),k)),Object.keys(a(H,A)).length){f(H,E,k);const Te=((c=L[0].match(/\//))==null?void 0:c.length)??0;(o[Te]||(o[Te]=[])).push(H)}continue}}(he===!0||he.test(u))&&(k[Ne]=u,h?(s.push(...x(this,$,W).call(this,H,e,k,a(b,E))),a(H,A)["*"]&&s.push(...x(this,$,W).call(this,a(H,A)["*"],e,k,a(b,E)))):(f(H,E,k),g.push(H)))}}n=g.concat(o.shift()??[])}return s.length>1&&s.sort((l,d)=>l.score-d.score),[s.map(({handler:l,params:d})=>[l,d])]}},B=new WeakMap,A=new WeakMap,X=new WeakMap,ce=new WeakMap,E=new WeakMap,$=new WeakSet,W=function(e,t,s,r){const n=[];for(let i=0,o=a(e,B).length;i<o;i++){const c=a(e,B)[i],l=c[t]||c[w],d={};if(l!==void 0&&(l.params=Object.create(null),n.push(l),s!==fe||r&&r!==fe))for(let u=0,h=l.possibleKeys.length;u<h;u++){const g=l.possibleKeys[u],y=d[l.score];l.params[g]=r!=null&&r[g]&&!y?r[g]:s[g]??(r==null?void 0:r[g]),d[l.score]=!0}}return n},Je),Q,Xe,Xt=(Xe=class{constructor(){m(this,"name","TrieRouter");p(this,Q);f(this,Q,new pt)}add(e,t,s){const r=tt(t);if(r){for(let n=0,i=r.length;n<i;n++)a(this,Q).insert(e,r[n],s);return}a(this,Q).insert(e,t,s)}match(e,t){return a(this,Q).search(e,t)}},Q=new WeakMap,Xe),xt=class extends dt{constructor(e={}){super(e),this.router=e.router??new Jt({routers:[new Zt,new Xt]})}},Qt=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(i=>typeof i=="string"?i==="*"?()=>i:o=>i===o?o:null:typeof i=="function"?i:o=>i.includes(o)?o:null)(s.origin),n=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(o,c){var u;function l(h,g){o.res.headers.set(h,g)}const d=r(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),s.origin!=="*"){const h=o.req.header("Vary");h?l("Vary",h):l("Vary","Origin")}if(s.credentials&&l("Access-Control-Allow-Credentials","true"),(u=s.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.maxAge!=null&&l("Access-Control-Max-Age",s.maxAge.toString());const h=n(o.req.header("origin")||"",o);h.length&&l("Access-Control-Allow-Methods",h.join(","));let g=s.allowHeaders;if(!(g!=null&&g.length)){const y=o.req.header("Access-Control-Request-Headers");y&&(g=y.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await c()}},es=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,qe=(e,t=ss)=>{const s=/\.([a-zA-Z0-9]+?)$/,r=e.match(s);if(!r)return;let n=t[r[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},ts={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ss=ts,rs=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),r=[];for(const n of s)n===".."&&r.length>0&&r.at(-1)!==".."?r.pop():n!=="."&&r.push(n);return r.join("/")||"."},bt={br:".br",zstd:".zst",gzip:".gz"},ns=Object.keys(bt),is="index.html",as=e=>{const t=e.root??"./",s=e.path,r=e.join??rs;return async(n,i)=>{var u,h,g,y;if(n.finalized)return i();let o;if(e.path)o=e.path;else try{if(o=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((u=e.onNotFound)==null?void 0:u.call(e,n.req.path,n)),i()}let c=r(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(o):o);e.isDir&&await e.isDir(c)&&(c=r(c,is));const l=e.getContent;let d=await l(c,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const R=e.mimes&&qe(c,e.mimes)||qe(c);if(n.header("Content-Type",R||"application/octet-stream"),e.precompressed&&(!R||es.test(R))){const b=new Set((h=n.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(v=>v.trim()));for(const v of ns){if(!b.has(v))continue;const P=await l(c+bt[v],n);if(P){d=P,n.header("Content-Encoding",v),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((g=e.onFound)==null?void 0:g.call(e,c,n)),n.body(d)}await((y=e.onNotFound)==null?void 0:y.call(e,c,n)),await i()}},os=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let r;t&&t.namespace?r=t.namespace:r=__STATIC_CONTENT;const n=s[e]||e;if(!n)return null;const i=await r.get(n,{type:"stream"});return i||null},ls=e=>async function(s,r){return as({...e,getContent:async i=>os(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,r)},cs=e=>ls(e);const T=new xt;T.use("/api/*",Qt());T.use("/static/*",cs({root:"./public"}));T.post("/api/create-payment-intent",async e=>{try{const{amountCents:t,currency:s="usd",email:r,enableTapToPay:n=!1}=await e.req.json();if(!t||t<50)return e.json({error:"Invalid amount. Minimum $0.50 required."},400);const i={clientSecret:"pi_mock_client_secret_"+Math.random().toString(36).substring(7),paymentIntentId:"pi_mock_"+Math.random().toString(36).substring(7),amount:t,currency:s,email:r,enableTapToPay:n};return e.json(i)}catch(t){return console.error("Payment intent creation error:",t),e.json({error:"Failed to create payment intent"},500)}});T.post("/api/stripe/connection-token",async e=>{try{const t={secret:"pst_test_"+Math.random().toString(36).substring(7)+"_mock_connection_token"};return console.log("Created mock connection token for Android middleware"),e.json(t)}catch(t){return console.error("Connection token creation error:",t),e.json({error:"Failed to create connection token"},500)}});T.post("/api/stripe/payment-intents",async e=>{try{const{amount:t,currency:s="usd",email:r,automatic_payment_methods:n}=await e.req.json();if(!t||t<50)return e.json({error:"Invalid amount. Minimum $0.50 required."},400);const i={client_secret:"pi_mock_"+Math.random().toString(36).substring(7)+"_secret_mock",id:"pi_mock_"+Math.random().toString(36).substring(7),amount:t,currency:s,status:"requires_payment_method"};return console.log(`Created mock payment intent for Android middleware: $${t/100}`),e.json(i)}catch(t){return console.error("Payment intent creation error:",t),e.json({error:"Failed to create payment intent"},500)}});T.get("/api/terminal/readers",async e=>{try{return e.json({readers:[{id:"tmr_mock_reader",device_type:"mobile_phone_reader",location:"mock_location",status:"online",label:"Android Tap to Pay"}]})}catch{return e.json({error:"Failed to fetch readers"},500)}});T.get("/api/hebcal",async e=>{try{const{lat:t=28.5383,lon:s=-81.3792,geonameid:r}=e.req.query();let n="https://www.hebcal.com/shabbat?cfg=json&m=50";r?n+=`&geonameid=${r}`:n+=`&latitude=${t}&longitude=${s}`;const o=await(await fetch(n)).json();return e.json(o)}catch(t){return console.error("Hebcal API error:",t),e.json({error:"Failed to fetch Hebrew calendar data"},500)}});T.get("/api/health",e=>e.json({status:"healthy",timestamp:new Date().toISOString()}));T.get("/api/config",e=>e.json({backendUrl:"https://donations.unmannedunited.com",paymentEndpoint:"/create-payment-intent",adminPin:"12345",locationId:null,latitude:28.5383,longitude:-81.3792,timeZoneId:"America/New_York",shacharit:"7:00 AM",mincha:"2:00 PM",maariv:"8:00 PM"}));T.post("/api/config",async e=>{try{const t=await e.req.json();return console.log("Config saved:",t),e.json({success:!0})}catch{return e.json({error:"Failed to save configuration"},500)}});T.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));const Ue=new xt,ds=Object.assign({"/src/index.tsx":T});let vt=!1;for(const[,e]of Object.entries(ds))e&&(Ue.route("/",e),Ue.notFound(e.notFoundHandler),vt=!0);if(!vt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Ue as default};
